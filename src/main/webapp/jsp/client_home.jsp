...
<div>
    ...
    <c:if test="${requestScope.show_cart == true}">
        ...
        <div class="container px-2" style="margin: 20px">
            <div class="row gx-2">
                <div class="col">
                    <a href="${path}/controller?command=create_order" style="color: #1a1e21; font-size: 20px; font-weight: bold">${create_order}</a>
                </div>
                <div class="col">
                    <a href="${path}/controller?command=clear_cart" style="color: #1a1e21; font-size: 20px; font-weight: bold">${cart_clear}</a>
                </div>
            </div>
        </div>
    </c:if>
